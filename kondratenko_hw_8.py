...
def get_day_week(day_number: str | int):
    day = int(day_number)
    if 1 > day or 7 < day:
        raise ValueError('WRONG Value')

    return f'It`s {days_week[day]}'


print(get_day_week(input('Enter the number of the day of the week from 1 to 7')))
...
def get_count_literals(text: str):
